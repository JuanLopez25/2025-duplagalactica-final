      ...
      <div className="App">
        {!userMail ? (
          ...
          <>
            ...
            {type==='client' && (
              <>
              <div className='input-container' style={{marginLeft: isSmallScreen ? openSearch ? '220px' : '114px' : openSearch ? '360px' :'96px', width: isSmallScreen ? '50%' : '30%', position: 'absolute', top: '0.5%'}}>

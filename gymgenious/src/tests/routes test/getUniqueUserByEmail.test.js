<<<<<<< Updated upstream:gymgenious/src/tests/routes test/getUniqueUserByEmail.test.js
...
jest.mock('../../../backend/services/usersRoutes.py', () => ({
    createUser: jest.fn(),
    getUniqueUserByEmail: jest.fn()
>>>>>>> Stashed changes:gymgenious/src/tests/routes test/usersTests/getUniqueUserByEmail.test.js
}));
